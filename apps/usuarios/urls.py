...
urlpatterns = [
    ...
    path('criar-perfil', usuario.CriarPefilUsuario.as_view(), name='criarperfil'),
    ...
    path('ajax/verificar-cidade-bd/', endereco.verificar_cidade_bd, name='verificar_cidade_bd'),
