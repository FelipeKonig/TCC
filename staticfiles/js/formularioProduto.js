$(document).ready(function () {
  ...
  $(document).on('click','.table-created-add', function(){

    var tabela = $(this).parents('table');

    var nova_linha = `<tr>
                        <td><input type="text" name="nome-caracteristica-${tabela.attr('id')}" class="form-control" required/></td>
                        <td><input type="text" name="descricao-caracteristica-${tabela.attr('id')}" class="form-control" required/></td>
                        <td class="pt-3-half">
                          <span class="table-up"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-up"
                                aria-hidden="true"></i></a></span>
                          <span class="table-down"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-down"
